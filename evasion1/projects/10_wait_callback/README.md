# A10 — Threadpool wait callback execution
...
Threadpool wait callback execution. Reconcile endpoint ownership, lifecycle state, and address-family or callback context instead of relying on one collection path.
